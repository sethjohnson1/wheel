      ...
      handleTouchStart: function (e) {
        ...
        if ($target) {
          ...
          if (settings.preventDefault.start) {
            //sj - commented this out due to console errors
      ...
      handleTouchMove: function (e) {
        ...
        if ($target) {
          ...
          if (settings.preventDefault.move) {
			...
			//sj - commented out due to console errrors
			// NEVERMIND this is solved with the CSS touch-action: none; for the wheel_img element
			event.preventDefault();
          }
